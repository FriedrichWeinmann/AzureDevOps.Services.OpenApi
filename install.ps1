<#
	.SYNOPSIS
		Installs the AzureDevOps.Services.OpenApi Module from github
		
	.DESCRIPTION
		This script installs the AzureDevOps.Services.OpenApi Module from github.
...
$ModuleName = "AzureDevOps.Services.OpenApi"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/AzureDevOps.Services.OpenApi"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "AzureDevOps.Services.OpenApi"
