...
.EXAMPLE
    PS C:\> Set-AdsWorkProcesseWorkitemtypeLayoutPageSectionGroup -GroupId $groupid -PageId $pageid -ProcessId $processid -WitRefName $witrefname -ApiVersion $apiversion -SectionId $sectionid -Organization $organization
