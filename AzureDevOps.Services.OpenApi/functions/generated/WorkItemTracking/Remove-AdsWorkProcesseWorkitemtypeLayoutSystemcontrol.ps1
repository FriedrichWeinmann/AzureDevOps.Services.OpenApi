...
.EXAMPLE
    PS C:\> Remove-AdsWorkProcesseWorkitemtypeLayoutSystemcontrol -ControlId $controlid -ProcessId $processid -ApiVersion $apiversion -WitRefName $witrefname -Organization $organization
