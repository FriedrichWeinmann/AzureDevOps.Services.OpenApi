...
.EXAMPLE
    PS C:\> Remove-AdsWorkProcessdefinitionWorkitemtypeLayoutPageSectionGroup -GroupId $groupid -PageId $pageid -ProcessId $processid -WitRefName $witrefname -ApiVersion $apiversion -SectionId $sectionid -Organization $organization
