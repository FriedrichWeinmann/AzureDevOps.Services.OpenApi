...
.EXAMPLE
    PS C:\> New-AdsWorkProcessdefinitionWorkitemtypeLayoutGroupControl -GroupId $groupid -WitRefName $witrefname -ProcessId $processid -ControlId $controlid -ApiVersion $apiversion -Organization $organization
