...
.EXAMPLE
    PS C:\> New-AdsWorkProcessdefinitionWorkitemtypeLayoutPageSectionGroup -GroupId $groupid -PageId $pageid -ProcessId $processid -WitRefName $witrefname -ApiVersion $apiversion -SectionId $sectionid -RemoveFromSectionId $removefromsectionid -Organization $organization
