...
.EXAMPLE
    PS C:\> Set-AdsWorkProcessdefinitionWorkitemtypeBehavior -WitRefNameForBehaviors $witrefnameforbehaviors -ProcessId $processid -ApiVersion $apiversion -Organization $organization
