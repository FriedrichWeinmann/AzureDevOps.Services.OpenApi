...
.EXAMPLE
    PS C:\> Remove-AdsWorkProcesseWorkitemtypeLayoutGroupControl -GroupId $groupid -WitRefName $witrefname -ProcessId $processid -ControlId $controlid -ApiVersion $apiversion -Organization $organization
