...
.EXAMPLE
    PS C:\> Set-AdsGitRepositoryPullrequestThreadComment -CommentId $commentid -PullRequestId $pullrequestid -ApiVersion $apiversion -ThreadId $threadid -Project $project -RepositoryId $repositoryid -Organization $organization
