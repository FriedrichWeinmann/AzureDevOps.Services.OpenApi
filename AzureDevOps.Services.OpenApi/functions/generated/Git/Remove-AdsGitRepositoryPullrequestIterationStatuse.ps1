...
.EXAMPLE
    PS C:\> Remove-AdsGitRepositoryPullrequestIterationStatuse -StatusId $statusid -PullRequestId $pullrequestid -IterationId $iterationid -ApiVersion $apiversion -Project $project -RepositoryId $repositoryid -Organization $organization
