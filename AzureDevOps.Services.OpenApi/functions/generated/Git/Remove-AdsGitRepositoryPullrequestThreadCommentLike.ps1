...
.EXAMPLE
    PS C:\> Remove-AdsGitRepositoryPullrequestThreadCommentLike -CommentId $commentid -PullRequestId $pullrequestid -ApiVersion $apiversion -ThreadId $threadid -Project $project -RepositoryId $repositoryid -Organization $organization
