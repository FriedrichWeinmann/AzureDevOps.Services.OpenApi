...
.EXAMPLE
    PS C:\> Get-AdsSourceproviderPathcontent -ProviderName $providername -ApiVersion $apiversion -Project $project -Organization $organization
...
#>
    ...
    process {
        ...
        $__path = 'https://dev.azure.com/{organization}/{project}/_apis/sourceProviders/{providerName}/pathcontents' -Replace '{providerName}',$ProviderName -Replace '{project}',$Project -Replace '{organization}',$Organization
