...
.EXAMPLE
    PS C:\> Set-AdsPackagingFeedMavenRecyclebinGroupArtifactVersion -GroupId $groupid -Project $project -Version $version -ApiVersion $apiversion -ArtifactId $artifactid -Feed $feed -Organization $organization
