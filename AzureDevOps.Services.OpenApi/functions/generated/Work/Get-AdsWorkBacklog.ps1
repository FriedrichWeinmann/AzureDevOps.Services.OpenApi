...
.EXAMPLE
    PS C:\> Get-AdsWorkBacklog -ApiVersion $apiversion -Organization $organization -Team $team -Project $project

    List all backlog levels

.EXAMPLE
    PS C:\> Get-AdsWorkBacklog -ApiVersion $apiversion -Id $id -Organization $organization -Team $team -Project $project
