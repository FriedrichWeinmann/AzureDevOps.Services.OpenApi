...
.EXAMPLE
    PS C:\> Get-AdsDistributedtaskEnvironmentProviderKubernete -ApiVersion $apiversion -ResourceId $resourceid -EnvironmentId $environmentid -Organization $organization -Project $project
