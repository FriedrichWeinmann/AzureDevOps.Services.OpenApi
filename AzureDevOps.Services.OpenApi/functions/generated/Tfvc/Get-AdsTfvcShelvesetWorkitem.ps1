...
.EXAMPLE
    PS C:\> Get-AdsTfvcShelvesetWorkitem -ApiVersion $apiversion -ShelvesetId $shelvesetid -Organization $organization
...
#>
    ...
    process {
        ...
        $__query = $PSBoundParameters | ConvertTo-Hashtable -Include @('ApiVersion','ShelvesetId') -Mapping $__mapping
