...
.EXAMPLE
    PS C:\> Get-AdsPackagingFeedNugetPackageVersion -FeedId $feedid -PackageVersion $packageversion -PackageName $packagename -ApiVersion $apiversion -Project $project -Organization $organization
