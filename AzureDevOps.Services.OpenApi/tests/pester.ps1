...
Remove-Module AzureDevOps.Services.OpenApi -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AzureDevOps.Services.OpenApi.psd1"
Import-Module "$PSScriptRoot\..\AzureDevOps.Services.OpenApi.psm1" -Force
